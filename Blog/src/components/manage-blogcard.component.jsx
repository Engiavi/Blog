...
export const ManageBlogCard = ({blog}) => {
  ...
  return (
    <>
    <div className='flex gap-10 border-b max-md:px-4 border-grey pb-6 items-center mb-6' >
        <img src={banner} className='max-md:hidden lg:hidden xl:block w-28 h-28 flex-none bg-grey object-cover'/>
        <div className='flex flex-col justify-betweenn py-2 w-full min-w-[300px]'>
            <div>
            ...
            <div className='flex gap-6 mt-3'>
                ...
                <button className='lg:hidden pr-4 py-2 underline text-twitter' onClick={()=>setShowStat(prev=>!prev)}>Stats</button>
...
<h1 className='blog-index text-twitter text-center pl-4 md:pl-6 flex-none'>[{index<10 ? "0"+index :index}]</h1>
<div>
